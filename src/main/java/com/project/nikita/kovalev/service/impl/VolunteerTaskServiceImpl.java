...
public class VolunteerTaskServiceImpl implements VolunteerTaskService {
    ...
    @Autowired
    public VolunteerTaskServiceImpl(VolunteerTaskRepository repository) {
    ...
    public void createVolunteerTask(long id, String title, String description,
                                    String taskDate, String address, boolean car, Status status) throws ServiceException {
